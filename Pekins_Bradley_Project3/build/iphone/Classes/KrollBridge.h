...
@interface Pekins_Bradley_Project3Object : KrollCoverageObject {
#else
@interface Pekins_Bradley_Project3Object : KrollObject {
#endif
@private
...
extern NSString * Pekins_Bradley_Project3$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	Pekins_Bradley_Project3Object *_pekins_bradley_project3;
    KrollObject* console;
	BOOL shutdown;
