...
/**
 Base class for all Pekins_Bradley_Project3 views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the Pekins_Bradley_Project3 view hierarchy (such as wrapped iOS UIViews) was touched.
