...
//Rare exceptions to indicate a bug in the _pekins_bradley_project3 code (Eg, function that a subclass should have implemented)
...
/**
 The base class for Pekins_Bradley_Project3 proxies.
 */
