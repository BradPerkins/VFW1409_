...
@interface Perkins_Bradley_Project1Object : KrollCoverageObject {
#else
@interface Perkins_Bradley_Project1Object : KrollObject {
#endif
@private
...
extern NSString * Perkins_Bradley_Project1$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	Perkins_Bradley_Project1Object *_perkins_bradley_project1;
    KrollObject* console;
	BOOL shutdown;
