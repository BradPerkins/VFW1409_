...
// in simulator we redefine to format for Perkins_Bradley_Project1 Developer console
...
{\
	NSString * exceptionName = [@"org.perkins_bradley_project1." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.perkins_bradley_project1";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIPerkins_Bradley_Project1NativeItemNone = -1, 
	UIPerkins_Bradley_Project1NativeItemSpinner = -2,
	UIPerkins_Bradley_Project1NativeItemProgressBar = -3,
	
	UIPerkins_Bradley_Project1NativeItemSlider = -4,
	UIPerkins_Bradley_Project1NativeItemSwitch = -5,
	UIPerkins_Bradley_Project1NativeItemMultiButton = -6,
	UIPerkins_Bradley_Project1NativeItemSegmented = -7,
	
	UIPerkins_Bradley_Project1NativeItemTextView = -8,
	UIPerkins_Bradley_Project1NativeItemTextField = -9,
	UIPerkins_Bradley_Project1NativeItemSearchBar = -10,
	
	UIPerkins_Bradley_Project1NativeItemPicker = -11,
	UIPerkins_Bradley_Project1NativeItemDatePicker = -12,
	
	UIPerkins_Bradley_Project1NativeItemInfoLight = -13,
	UIPerkins_Bradley_Project1NativeItemInfoDark = -14,
	
	UIPerkins_Bradley_Project1NativeItemDisclosure = -15,
	
	UIPerkins_Bradley_Project1NativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Perkins_Bradley_Project1 instances of
