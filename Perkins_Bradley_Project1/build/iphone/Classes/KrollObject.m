...
//@interface Perkins_Bradley_Project1Object : NSObject
//@end

@interface Perkins_Bradley_Project1Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[Perkins_Bradley_Project1Object class]])
		{
			for (NSString *key in [[(Perkins_Bradley_Project1Object*)o modules] allKeys])
			{
