...
//@interface Pekins_Bradley_Project3Object : NSObject
//@end

@interface Pekins_Bradley_Project3Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[Pekins_Bradley_Project3Object class]])
		{
			for (NSString *key in [[(Pekins_Bradley_Project3Object*)o modules] allKeys])
			{
