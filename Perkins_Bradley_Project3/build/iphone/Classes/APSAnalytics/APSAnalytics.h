 ...
 * to send analytic data that can be viewed on the Pekins_Bradley_Project3 Dashboard.
 *
 * For information on getting started with Pekins_Bradley_Project3 Platform Services,
