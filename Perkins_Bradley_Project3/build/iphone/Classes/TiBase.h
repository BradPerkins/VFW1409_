...
// in simulator we redefine to format for Pekins_Bradley_Project3 Developer console
...
{\
	NSString * exceptionName = [@"org.pekins_bradley_project3." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.pekins_bradley_project3";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIPekins_Bradley_Project3NativeItemNone = -1, 
	UIPekins_Bradley_Project3NativeItemSpinner = -2,
	UIPekins_Bradley_Project3NativeItemProgressBar = -3,
	
	UIPekins_Bradley_Project3NativeItemSlider = -4,
	UIPekins_Bradley_Project3NativeItemSwitch = -5,
	UIPekins_Bradley_Project3NativeItemMultiButton = -6,
	UIPekins_Bradley_Project3NativeItemSegmented = -7,
	
	UIPekins_Bradley_Project3NativeItemTextView = -8,
	UIPekins_Bradley_Project3NativeItemTextField = -9,
	UIPekins_Bradley_Project3NativeItemSearchBar = -10,
	
	UIPekins_Bradley_Project3NativeItemPicker = -11,
	UIPekins_Bradley_Project3NativeItemDatePicker = -12,
	
	UIPekins_Bradley_Project3NativeItemInfoLight = -13,
	UIPekins_Bradley_Project3NativeItemInfoDark = -14,
	
	UIPekins_Bradley_Project3NativeItemDisclosure = -15,
	
	UIPekins_Bradley_Project3NativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Pekins_Bradley_Project3 instances of
