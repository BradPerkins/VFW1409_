...
/**
 The base class for all Pekins_Bradley_Project3 modules
 */
...
/**
 Pekins_Bradley_Project3 Platform calls this method on startup.
 */
-(void)startup;

/**
 Pekins_Bradley_Project3 Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 Pekins_Bradley_Project3 Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 Pekins_Bradley_Project3 Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 Pekins_Bradley_Project3 Platform calls this method on resume.
 @param sender The sender of the event.
 */
