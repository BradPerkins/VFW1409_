...
/**
 Base class for all Perkins_Bradley_Project2 views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the Perkins_Bradley_Project2 view hierarchy (such as wrapped iOS UIViews) was touched.
