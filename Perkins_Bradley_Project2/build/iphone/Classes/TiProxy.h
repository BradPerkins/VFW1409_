...
//Rare exceptions to indicate a bug in the _perkins_bradley_project2 code (Eg, function that a subclass should have implemented)
...
/**
 The base class for Perkins_Bradley_Project2 proxies.
 */
