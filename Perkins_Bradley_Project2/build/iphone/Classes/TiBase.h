...
// in simulator we redefine to format for Perkins_Bradley_Project2 Developer console
...
{\
	NSString * exceptionName = [@"org.perkins_bradley_project2." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.perkins_bradley_project2";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIPerkins_Bradley_Project2NativeItemNone = -1, 
	UIPerkins_Bradley_Project2NativeItemSpinner = -2,
	UIPerkins_Bradley_Project2NativeItemProgressBar = -3,
	
	UIPerkins_Bradley_Project2NativeItemSlider = -4,
	UIPerkins_Bradley_Project2NativeItemSwitch = -5,
	UIPerkins_Bradley_Project2NativeItemMultiButton = -6,
	UIPerkins_Bradley_Project2NativeItemSegmented = -7,
	
	UIPerkins_Bradley_Project2NativeItemTextView = -8,
	UIPerkins_Bradley_Project2NativeItemTextField = -9,
	UIPerkins_Bradley_Project2NativeItemSearchBar = -10,
	
	UIPerkins_Bradley_Project2NativeItemPicker = -11,
	UIPerkins_Bradley_Project2NativeItemDatePicker = -12,
	
	UIPerkins_Bradley_Project2NativeItemInfoLight = -13,
	UIPerkins_Bradley_Project2NativeItemInfoDark = -14,
	
	UIPerkins_Bradley_Project2NativeItemDisclosure = -15,
	
	UIPerkins_Bradley_Project2NativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Perkins_Bradley_Project2 instances of
