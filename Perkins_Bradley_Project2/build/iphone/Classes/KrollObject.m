...
//@interface Perkins_Bradley_Project2Object : NSObject
//@end

@interface Perkins_Bradley_Project2Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[Perkins_Bradley_Project2Object class]])
		{
			for (NSString *key in [[(Perkins_Bradley_Project2Object*)o modules] allKeys])
			{
