...
@interface Perkins_Bradley_Project2Object : KrollCoverageObject {
#else
@interface Perkins_Bradley_Project2Object : KrollObject {
#endif
@private
...
extern NSString * Perkins_Bradley_Project2$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	Perkins_Bradley_Project2Object *_perkins_bradley_project2;
    KrollObject* console;
	BOOL shutdown;
