...
/**
 The base class for all Perkins_Bradley_Project4 modules
 */
...
/**
 Perkins_Bradley_Project4 Platform calls this method on startup.
 */
-(void)startup;

/**
 Perkins_Bradley_Project4 Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 Perkins_Bradley_Project4 Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 Perkins_Bradley_Project4 Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 Perkins_Bradley_Project4 Platform calls this method on resume.
 @param sender The sender of the event.
 */
