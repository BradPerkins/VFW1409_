...
//@interface Perkins_Bradley_Project4Object : NSObject
//@end

@interface Perkins_Bradley_Project4Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[Perkins_Bradley_Project4Object class]])
		{
			for (NSString *key in [[(Perkins_Bradley_Project4Object*)o modules] allKeys])
			{
