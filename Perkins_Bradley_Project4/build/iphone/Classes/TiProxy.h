...
//Rare exceptions to indicate a bug in the _perkins_bradley_project4 code (Eg, function that a subclass should have implemented)
...
/**
 The base class for Perkins_Bradley_Project4 proxies.
 */
