 ...
 * to send analytic data that can be viewed on the Perkins_Bradley_Project4 Dashboard.
 *
 * For information on getting started with Perkins_Bradley_Project4 Platform Services,
