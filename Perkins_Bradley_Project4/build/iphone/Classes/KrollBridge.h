...
@interface Perkins_Bradley_Project4Object : KrollCoverageObject {
#else
@interface Perkins_Bradley_Project4Object : KrollObject {
#endif
@private
...
extern NSString * Perkins_Bradley_Project4$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	Perkins_Bradley_Project4Object *_perkins_bradley_project4;
    KrollObject* console;
	BOOL shutdown;
