...
// in simulator we redefine to format for Perkins_Bradley_Project4 Developer console
...
{\
	NSString * exceptionName = [@"org.perkins_bradley_project4." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.perkins_bradley_project4";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIPerkins_Bradley_Project4NativeItemNone = -1, 
	UIPerkins_Bradley_Project4NativeItemSpinner = -2,
	UIPerkins_Bradley_Project4NativeItemProgressBar = -3,
	
	UIPerkins_Bradley_Project4NativeItemSlider = -4,
	UIPerkins_Bradley_Project4NativeItemSwitch = -5,
	UIPerkins_Bradley_Project4NativeItemMultiButton = -6,
	UIPerkins_Bradley_Project4NativeItemSegmented = -7,
	
	UIPerkins_Bradley_Project4NativeItemTextView = -8,
	UIPerkins_Bradley_Project4NativeItemTextField = -9,
	UIPerkins_Bradley_Project4NativeItemSearchBar = -10,
	
	UIPerkins_Bradley_Project4NativeItemPicker = -11,
	UIPerkins_Bradley_Project4NativeItemDatePicker = -12,
	
	UIPerkins_Bradley_Project4NativeItemInfoLight = -13,
	UIPerkins_Bradley_Project4NativeItemInfoDark = -14,
	
	UIPerkins_Bradley_Project4NativeItemDisclosure = -15,
	
	UIPerkins_Bradley_Project4NativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Perkins_Bradley_Project4 instances of
